# Generated by Django 4.2.4 on 2023-08-14 21:42
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('incremento_minimo', models.FloatField(default=100.0)),
            ],
        ),
        migrations.CreateModel(
            name='Lotes',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('leiloes', models.ManyToManyField(to='website.leiloes')),
                ('negociacoes', models.ManyToManyField(to='website.negociacoes')),
            ],
        ),
        migrations.CreateModel(
            name='Produtos',
            fields=[
                ...
                ('leilao', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='website.leiloes')),
                ('lote', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='website.lotes')),
                ('negociacoes', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='website.negociacoes')),
            ],
        ),
        migrations.CreateModel(
            name='Licitacoes',
            fields=[
                ...
                ('leilao', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='website.leiloes')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('produto', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='website.produtos')),
            ],
        ),
        migrations.CreateModel(
            name='Faturas',
            fields=[
                ...
                ('data_fatura', models.DateTimeField(verbose_name='Data da fatura')),
